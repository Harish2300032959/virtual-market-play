  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-6">
        ...
        {/* Demo Account Info */}
        <Card className="trading-card border-blue-500/20 bg-blue-500/5">
          <CardContent className="pt-6">
            <div className="text-center">
              <h3 className="font-medium mb-2">Try Demo Account</h3>
              <p className="text-sm text-muted-foreground mb-3">
                Use these credentials to explore the platform with sample data:
              </p>
              <div className="text-sm space-y-1">
                <p><strong>Email:</strong> demo@tradepro.com</p>
